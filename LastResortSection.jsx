...
//
// INTEGRATION: Add this component as the third section in
// LenderMatch.jsx, below the Alternative Path (Non-QM) section.
//
// Usage:
//   <LastResortSection
//     scenario={scenario}
//     agencyResultCount={agencyResults.length}
//     nonQMResultCount={nonQMResults.length}
//   />
// ============================================================

import { useState, useEffect } from "react";
import { evaluateHardMoneyPath } from "./LenderMatchEngine_hardMoney";
...
const LastResortSection = ({ scenario, agencyResultCount = 0, nonQMResultCount = 0 }) => {
  ...
  useEffect(() => {
    ...
    // If hero mode (all else failed), expand by default
  ...
  return (
    <div style={{ marginTop: heroMode ? "0" : "32px" }}>
      ...
      <div
        style={{
          background: heroMode
            ? "linear-gradient(135deg, #e8531a18 0%, #1a1f2e 100%)"
            : "#141824",
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
            ...
            <div>
              ...
              <div
                style={{
                  color: heroMode ? "#e8531a" : "#64748b",
                  fontSize: "12px",
                  marginTop: "2px",
                  fontStyle: heroMode ? "normal" : "italic",
                }}
              >
                {heroMode
