...
export default function CollateralIntel() {
  ...
  const handleSaveToRecord = async () => {
    ...
    try {
      ...
      if (appraisalConcerns?.overallRisk === 'CRITICAL' || appraisalConcerns?.overallRisk === 'HIGH') riskFlags.push({ flagCode: 'APPRAISAL_REVIEW_RISK', sourceModule: 'COLLATERAL_INTEL', severity: appraisalConcerns.overallRisk === 'CRITICAL' ? 'HIGH' : 'MEDIUM', detail: 'Appraisal review: ' + appraisalConcerns.overallRisk + ' risk — ' + (appraisalConcerns.concerns?.length || 0) + ' concerns' });
      if (appraisalConcerns?.flipRisk?.detected) riskFlags.push({ flagCode: 'FLIP_RISK_DETECTED', sourceModule: 'COLLATERAL_INTEL', severity: 'HIGH', detail: 'Flip risk: ' + (appraisalConcerns.flipRisk.summary || '') });
  ...
  return (
    <div className="min-h-screen bg-slate-50" style={{ fontFamily: "'DM Sans', system-ui, sans-serif" }}>
      ...
      <DecisionRecordBanner
        ...
        moduleName="Collateral Intelligence™"
        moduleKey="COLLATERAL_INTEL"
