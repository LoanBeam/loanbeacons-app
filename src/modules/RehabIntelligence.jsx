    ...
    <div className="min-h-screen bg-slate-50" style={{ fontFamily: "'DM Sans', system-ui, sans-serif" }}>
      ...
      <div className="bg-slate-900 px-6 py-10">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-slate-400">Agency · Hard Money · Non-QM · DSCR Fix & Hold · AI contractor bid analysis</p>
        </div>
      </div>
          ...
          {scenarios.length === 0 ? <p className="text-slate-400 text-sm">No scenarios found.</p> :
            <div className="space-y-2">{scenarios.map(s => (
              <button key={s.id} onClick={() => navigate('/rehab-intelligence?scenarioId=' + s.id)}
                className="w-full text-left p-4 border border-slate-200 rounded-2xl hover:border-orange-400 hover:bg-orange-50 transition-all">
