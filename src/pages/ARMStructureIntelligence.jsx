                ...
                return (
                  <button key={s.id} onClick={() => navigate('/arm-structure?scenarioId=' + s.id)}
                    ...
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <span className="text-slate-300 group-hover:text-orange-400 text-lg shrink-0">→</span>
                    </div>
                  </button>
                );
              })}
  ...
  return (
    <div className="min-h-screen bg-slate-50" style={{ fontFamily: "'DM Sans', system-ui, sans-serif" }}>
      ...
      <div className="bg-slate-900 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10" style={{ backgroundImage: 'radial-gradient(circle at 20% 50%, #ea580c 0%, transparent 50%), radial-gradient(circle at 80% 20%, #f97316 0%, transparent 40%)' }} />
        <div className="relative max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="flex items-start justify-between flex-wrap gap-6">
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ fontFamily: "'DM Serif Display', Georgia, serif" }} className="text-4xl font-normal text-white mb-2">ARM Structure Intelligence™</h1>
              <p className="text-slate-400 text-base max-w-xl">Caps · Payment Stress Test · Qualifying Analysis · ARM vs Fixed · Disclosure</p>
            </div>
            <div className="bg-slate-800/60 border border-slate-700 rounded-2xl px-5 py-4" style={{ minWidth: '240px', flexShrink: 0 }}>
              ...
              {scenario && <div className="text-slate-400 text-sm mt-1">{scenario.streetAddress || scenario.loanType || ''}</div>}
              <button onClick={() => navigate('/arm-structure')} className="text-xs text-orange-400 hover:text-orange-300 mt-2 block transition-colors">Change scenario →</button>
            </div>
          </div>
        </div>
      </div>
