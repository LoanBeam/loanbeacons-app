          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <h1 style={{ fontFamily: "'DM Serif Display', Georgia, serif" }} className="text-2xl font-normal text-white mt-0.5">Credit Intelligence™</h1>
              </div>
            </div>
            <p className="text-indigo-300 text-sm leading-relaxed mb-5">Analyze credit profiles, tri-merge tradelines, derogatory history, and score improvement paths for every borrower.</p>
            <div className="flex flex-wrap gap-2">
              {['Tri-Merge Analysis', 'Score Improvement', 'Derogatory Review', 'Tradeline Audit', 'Rapid Rescore', 'Borrower Letter'].map(tag => (
