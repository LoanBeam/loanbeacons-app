    ...
    <div className="min-h-screen bg-slate-50" style={{ fontFamily: "'DM Sans', system-ui, sans-serif" }}>
      ...
      <div className="bg-slate-900 px-6 py-8">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-slate-400">Property analysis · Appraisal review · Waiver coach · Rebuttal letters</p>
        </div>
      </div>
              ...
              <button key={s.id} onClick={() => navigate('/property-intel?scenarioId=' + s.id)}
                ...
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <div className="text-xs text-slate-500 mt-0.5">{fmt0(s.loanAmount)} · {s.loanType} · {s.propertyType || 'SFR'}</div>
                  </div>
