  ...
  const handleSaveToRecord = async () => {
    ...
    try {
      const riskFlags = netCashToClose > loanAmount * 0.05
        ? [{ flagCode: 'CASH_TO_CLOSE_HIGH', sourceModule: 'CLOSING_COST_CALC', severity: 'MEDIUM', detail: 'Cash to close exceeds 5% of loan amount — verify borrower has sufficient reserves' }]
        : [];
        ...
        <div className="bg-gradient-to-br from-slate-900 to-indigo-950 px-6 py-10">
          <div className="max-w-2xl mx-auto">
            ...
            <div className="flex flex-wrap gap-2">
              {['Section A–H Itemization', 'Prepaids & Escrow', 'APR Calculation', 'Lender Credit Optimizer', 'Cash-to-Close Summary', 'CD Reconciliation'].map(tag => (
  ...
  return (
    <div className="min-h-screen bg-slate-50" style={{ fontFamily: "'DM Sans', system-ui, sans-serif" }}>
      ...
      <DecisionRecordBanner
        ...
        moduleName="Closing Cost Calculator™"
        moduleKey="CLOSING_COST_CALC"
      ...
      <div className="bg-slate-900 relative overflow-hidden" style={{ minHeight: '200px' }}>
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="flex items-start justify-between flex-wrap gap-6">
            <div>
              <div className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">LOANBEACONS™ — Module 20</div>
