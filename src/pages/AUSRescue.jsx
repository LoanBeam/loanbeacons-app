        ...
        <div className="bg-gradient-to-br from-slate-900 to-indigo-950 px-6 py-10">
          <div className="max-w-2xl mx-auto">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <span className="text-xs font-bold tracking-widest text-indigo-400 uppercase">Stage 2 — Strategy</span>
                <h1 style={{ fontFamily: "'DM Serif Display', Georgia, serif" }} className="text-2xl font-normal text-white mt-0.5">AUS Rescue™</h1>
              </div>
            </div>
            <p className="text-indigo-300 text-sm leading-relaxed mb-5">Upload DU or LP findings to diagnose refer/ineligible decisions. Get fix strategies, program migration options, and a Deal Advisor recommendation.</p>
            <div className="flex flex-wrap gap-2">
              {['DU / LP Upload', 'Fix In Place', 'Program Migration', 'Deal Advisor™', 'Approval Probability', 'Scenario Write-Back'].map(tag => (
          ...
          {scenarios.length === 0 ? (
            ...
            <div className="space-y-2.5">
              ...
              {displayed.map(s => {
                ...
                return (
                  <button key={s.id} onClick={() => navigate('/aus-rescue?scenarioId=' + s.id)}
