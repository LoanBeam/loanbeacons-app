    ...
    <div className="min-h-screen bg-slate-50" style={{ fontFamily: "'DM Sans', system-ui, sans-serif" }}>
      ...
      <div className="bg-slate-900 px-6 py-10">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-slate-400">FEMA flood zone · NFIP · Insurance tracking · Coverage calculator · AI risk assessment</p>
        </div>
      </div>
          ...
          {scenarios.length === 0 ? <p className="text-slate-400 text-sm">No scenarios found.</p> :
            <div className="space-y-2">{scenarios.map(s => (
              <button key={s.id} onClick={() => navigate('/flood-intel?scenarioId=' + s.id)}
                className="w-full text-left p-4 border border-slate-200 rounded-2xl hover:border-cyan-400 hover:bg-cyan-50 transition-all">
